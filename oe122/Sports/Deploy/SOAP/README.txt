...
3. On the AppObject tab enter a name (example: “WSTest"). 
...
9. In the General tab select "Web Services” as the Client Type. 
...
15. Choose "Document/Literal” (aka. “Doc/Literal”) in the WSDL Style box. 
