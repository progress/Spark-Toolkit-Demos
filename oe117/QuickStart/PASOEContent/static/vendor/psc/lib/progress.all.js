        ...
        JSDOTransport = kendo.data.RemoteTransport.extend({
            ...
            _convertStringToDate: function (data, fieldName, targetFieldName) {
                ...
                if (array.length > 0) {
                     ...
                     *     parseInt(array[3], 10));
                     */
                    /* Adjusting date conversion to use UTC, not local timezone. */
            ...
            read: function (options) {
                try {
                    ...
                    callback = function onAfterFillJSDO(object, success, request) {
                        var data = {}, saveUseRelationships, promise, total, exception, jsdo;

                        object = progress.util.Deferred.getParamObject(object, success, request);
                        jsdo = object.jsdo;
                        ...
                        if (success) {
                            ...
                            if (options.data && options.data.take) {
                                if (!transport.readLocal &&
                                    ...
                                    /*jslint unparam: true*/
                                    promise.then(function (object, success, request) {
                                        var exception, total, jsdo;
                                    ...
                                    }, function (object, success, request) {
                                        var exception, jsdo;
                    ...
                    jsdo.fill(filter).then(callback, callback);
            ...
            _saveChanges: function (options) {
                var transport = this,
                    callback = function onAfterSaveChanges(object, success, request) {
                        var jsrecord,
                            xhr,
                            status,
                            exception,
                ...
                if (this.autoSave) {
                    this.jsdo.saveChanges(this.jsdo._hasSubmitOperation).then(callback, callback);
                } else {
