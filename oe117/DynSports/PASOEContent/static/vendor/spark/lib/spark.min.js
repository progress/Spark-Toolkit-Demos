/*
 ...
 @license Apache-2.0
*/
(function(d,f,a,b){if(d&&f&&a&&"undefined"===typeof b.spark){var c=null,e=null,g=null,h=null,n={id:"",filterQuery:"",data:{},success:!1,error:!1},k=null;b.spark={version:"vPRE (2018.07.23.054101)",field:{},form:{},grid:{},loader:{},nav:{},notify:{},strings:{},jsdoError:function(a){var c=((a.xhr||{}).jsdo||{getErrors:function(){return[]}}).getErrors(),e=[];d.each(c,function(b,a){switch(a.type){case -1:var c=null;if(a.responseText)try{c=JSON.parse(a.responseText||"")}catch(r){console.log("Error while parsing response: "+
...
c.tableRef+"' does not exist in JSDO buffers."),delete c.tableRef);var m=new f.data.DataSource(d.extend(n,c)),k=[];m.getFieldSchema=function(a){if(0===k.length){var b=(m.transport||{}).jsdo||null;k=b?b.getSchema():[]}return d.grep(k,function(b){return b.title==a})[0]||{}};return m}catch(q){return console.log("Unable to create JSDO DataSource for "+a+":",c),console.log(q.stack),new f.data.DataSource}},jsdo_read:function(a,c){var d=null,d=c.filterQuery||"",d=""===d?a.fill():a.fill(d);d.done(function(a,
b,c){}).fail(b.spark.jsdoFailure);return d},jsdo_create:function(a,c){a.add(c.data);var d=a.saveChanges(c.useSubmit);d.done(function(a,b,c){}).fail(b.spark.jsdoFailure);return d},jsdo_update:function(a,c){var d={},d=c.tableRef&&a[c.tableRef]?a[c.tableRef].findById(c.id):a.findById(c.id);try{d.assign(c.data)}catch(p){c.error(null,null,p)}d=a.saveChanges(c.useSubmit);d.done(function(a,b,c){}).fail(b.spark.jsdoFailure);return d},jsdo_delete:function(a,c){var d=a.findById(c.id);try{d.remove()}catch(p){c.error(null,
null,p)}d=a.saveChanges(c.useSubmit);d.done(function(a,b,c){}).fail(b.spark.jsdoFailure);return d}}}})(window.jQuery,window.kendo,window.progress,window);
...
filter:"contains",suggest:!0,valuePrimitive:!0},b)).getKendoMultiSelect():c.kendoDropDownList(d.extend({dataSource:new f.data.DataSource,filter:"contains",valuePrimitive:!0},b)).getKendoDropDownList();if(!b.invokeResource)return console.log("Resource name was not specified for invoke lookup:",a),e;e&&b.invokeResource&&(e._jsdo=window.spark.createJSDO(b.invokeResource),b.invokeMethod?(e.fetchData=function(a){return e._jsdo.invoke(b.invokeMethod,a||{}).done(function(a){a=a.response||{};b.invokeDataProperty?
